...
from PerceptronMult.Perceptron_Mult import Perceptron
...
for r in range(R):
    ...
    layer_dims = [X_treino.shape[1], 5, 1]
    ps = Perceptron_Mult(layer_dims, X_treino.T, y_treino, plot=True, max_epoch=1000, learning_rate=0.01)
    ps.fit()
